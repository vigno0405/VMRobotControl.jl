...
robot = parseURDF(joinpath(module_path, "/home/vigno/github/VMRobotControl.jl/URDFs/franka_hand_description/franka_hand.urdf"), cfg)
...
K = SMatrix{3, 3}(10., 0., 0., 0., 20., 0., 0., 0., 30.)
...
# Animate
animate_robot_odesolution(fig, sol, plotting_kcache, "franka_state_machine.mp4")
