...
K_orient = 10.0
D_orient = 0.1
add_component!(vms, TanhSpring("pos_error"; max_force=50.0, stiffness=K_pos);          id="pos_spring")
add_component!(vms, LinearDamper(D_pos, "pos_error");                                 id="pos_damper")
add_component!(vms, TanhSpring("orient_error"; max_force=50.0, stiffness=K_orient);   id="orient_spring")
add_component!(vms, LinearDamper(D_orient, "orient_error");                       id="orient_damper")
...
add_coordinate!(vm, FramePoint(frame_y, SVector(0., 0., target_pos.val[][3]).+0.1),  id="CartYPosition")
...
add_component!(vms, TanhSpring("palm_to_cart"; max_force=20.0, stiffness=K_pos);      id="palm_spring")
...
# Animate
animate_robot_odesolution(fig, sol, plotting_kcache, "franka_hand.mp4")